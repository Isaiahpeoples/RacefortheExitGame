...
class Game:
    def __init__(self):
        ...
        self.sprites = []
        self.running = True
        self.game_over_text = self.canvas.create_text(250, 230, text='YOU  WIN!', fill='red', font=('Courier',50), state='hidden')
    ...
    def mainloop(self):
        while True:
            if self.running == True and self.started == True:
...
platform4 = NonMovingSprite(g, PhotoImage(file='platform1.gif'), \
    300, 160, 100, 10)
platform5 = NonMovingSprite(g, PhotoImage(file='platform2.gif'), \
    175, 350, 66, 10)
...
platform8 = NonMovingSprite(g, PhotoImage(file='platform2.gif'), \
    45, 60, 66, 10)
platform9 = NonMovingSprite(g, PhotoImage(file='platform3.gif'), \
    170, 250, 32, 10)
